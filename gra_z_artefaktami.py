    ...
    def zaatakuj(self, wrog, jaka_czesc):
        if self.chce or self.musi:
            if wrog in self.drużyna:
                ...
                return
            elif self.bronie == bronie["włócznia"] or bronie["ostra_włócznia"]:
                for i in range(3):
...
pos4 = Postać("elf", "Romeo", 200000.0, 250000.0, 50000.0, 50000.0, 75000.0, 12500.0, 12500.0, 50000.0, 100000.0, 100.0, 100.0,100.0, 100.0, 5.0, 10.0, zbroje["czarno_zbroja"], bronie["łuk"],True,False)
pos5 = Postać("elf","Rukur",200000.0, 250000.0, 50000.0, 50000.0, 25000.0, 12500.0, 12500.0, 175000.0, 125000.0, 100.0,100.0, 10.0, 100.0, 5.0, 10.0, zbroje["metalowa_zbroja"],bronie["włócznia"],False,True)
pos6 = Postać("elf","Rokil",100000.0, 250000.0, 50000.0, 50000.0, 25000.0, 12500.0, 12500.0, 175000.0, 125000.0, 100.0,100.0, 10.0, 100.0, 5.0, 10.0, zbroje["metalowa_zbroja"],bronie["włócznia"],False,True)
...
zapis = {"pos1":{"imie":pos1.imie,
                ...
                "brzuch":pos1.brzuch,
                "brzuch":pos1.lrzebro,
                "przebro":pos1.przebro,
                "lnoga":pos1.lnoga,
                "lnoga":pos1.pnoga,
                "artefakty":pos1.artefakty,
                "za_atak":pos1.za_atak,
                "za_obrona":pos1.za_obrona,
                "atak":pos1.atak,
                "obrona":pos1.obrona,
                "zbroja":pos1.zbroja,
                "bronie":pos1.bronie,
                "umiejętności":pos1.umiejętności,
                "ciało":pos1.ciało,
                "nczęści_ciała":pos1.nczęści_ciała,
                "części_ciała":pos1.części_ciała,
                "ogłuszony":pos1.ogłuszony,
                "czas_ogłuszenia":pos1.czas_ogłuszenia,
                "chce":pos1.chce,
                "musi":pos1.musi,
                "tury":pos1.tury,
                "drużyna":pos1.drużyna,
                "wrogowie":pos1.wrogowie,
                "ekwipunek":pos1.ekwipunek,
                "oszczędzenie":pos1.oszczędzenie,
                "relacje":pos1.relacje,
                "wochuk_uses":pos1.wochuk_uses,
                "cozwoj_uses":pos1.cozwoj_uses},
        "pos2":{"imie":pos2.imie,
                "głód":pos2.głód,
                "mgłód":pos2.mgłód,
                "napojenie":pos2.napojenie,
                "mnapojenie":pos2.mnapojenie,
                "napojenie":pos2.istota,
                "głowa":pos2.głowa,
                "klatka":pos2.klatka,
                "lręka":pos2.lręka,  
                "pręka":pos2.pręka,
                "brzuch":pos2.brzuch,
                "brzuch":pos2.lrzebro,
                "przebro":pos2.przebro,
                "lnoga":pos2.lnoga,
                "lnoga":pos2.pnoga,
                "artefakty":pos2.artefakty,
                "za_atak":pos2.za_atak,
                "za_obrona":pos2.za_obrona,
                "atak":pos2.atak,
                "obrona":pos2.obrona,
                "zbroja":pos2.zbroja,
                "bronie":pos2.bronie,
                "umiejętności":pos2.umiejętności,
                "ciało":pos2.ciało,
                "nczęści_ciała":pos2.nczęści_ciała,
                "części_ciała":pos2.części_ciała,
                "ogłuszony":pos2.ogłuszony,
                "czas_ogłuszenia":pos2.czas_ogłuszenia,
                "chce":pos2.chce,
                "musi":pos2.musi,
                "tury":pos2.tury,
                "drużyna":pos2.drużyna,
                "wrogowie":pos2.wrogowie,
                "ekwipunek":pos2.ekwipunek,
                "oszczędzenie":pos2.oszczędzenie,
                "relacje":pos2.relacje,
                "wochuk_uses":pos2.wochuk_uses,
                "cozwoj_uses":pos2.cozwoj_uses},
        "pos3":{"imie":pos3.imie,
                "głód":pos3.głód,
                "mgłód":pos3.mgłód,
                "napojenie":pos3.napojenie,
                "mnapojenie":pos3.mnapojenie,
                "napojenie":pos3.istota,
                "głowa":pos3.głowa,
                "klatka":pos3.klatka,
                "lręka":pos3.lręka,  
                "pręka":pos3.pręka,
                "brzuch":pos3.brzuch,
                "brzuch":pos3.lrzebro,
                "przebro":pos3.przebro,
                "lnoga":pos3.lnoga,
                "lnoga":pos3.pnoga,
                "artefakty":pos3.artefakty,
                "za_atak":pos3.za_atak,
                "za_obrona":pos3.za_obrona,
                "atak":pos3.atak,
                "obrona":pos3.obrona,
                "zbroja":pos3.zbroja,
                "bronie":pos3.bronie,
                "umiejętności":pos3.umiejętności,
                "ciało":pos3.ciało,
                "nczęści_ciała":pos3.nczęści_ciała,
                "części_ciała":pos3.części_ciała,
                "ogłuszony":pos3.ogłuszony,
                "czas_ogłuszenia":pos3.czas_ogłuszenia,
                "chce":pos3.chce,
                "musi":pos3.musi,
                "tury":pos3.tury,
                "drużyna":pos3.drużyna,
                "wrogowie":pos3.wrogowie,
                "ekwipunek":pos3.ekwipunek,
                "oszczędzenie":pos3.oszczędzenie,
                "relacje":pos3.relacje,
                "wochuk_uses":pos3.wochuk_uses,
                "cozwoj_uses":pos3.cozwoj_uses},
        "pos4":{"imie":pos4.imie,
                "głód":pos4.głód,
                "mgłód":pos4.mgłód,
                "napojenie":pos4.napojenie,
                "mnapojenie":pos4.mnapojenie,
                "napojenie":pos4.istota,
                "głowa":pos4.głowa,
                "klatka":pos4.klatka,
                "lręka":pos4.lręka,  
                "pręka":pos4.pręka,
                "brzuch":pos4.brzuch,
                "brzuch":pos4.lrzebro,
                "przebro":pos4.przebro,
                "lnoga":pos4.lnoga,
                "lnoga":pos4.pnoga,
                "artefakty":pos4.artefakty,
                "za_atak":pos4.za_atak,
                "za_obrona":pos4.za_obrona,
                "atak":pos4.atak,
                "obrona":pos4.obrona,
                "zbroja":pos4.zbroja,
                "bronie":pos4.bronie,
                "umiejętności":pos4.umiejętności,
                "ciało":pos4.ciało,
                "nczęści_ciała":pos4.nczęści_ciała,
                "części_ciała":pos4.części_ciała,
                "ogłuszony":pos4.ogłuszony,
                "czas_ogłuszenia":pos4.czas_ogłuszenia,
                "chce":pos4.chce,
                "musi":pos4.musi,
                "tury":pos4.tury,
                "drużyna":pos4.drużyna,
                "wrogowie":pos4.wrogowie,
                "ekwipunek":pos4.ekwipunek,
                "oszczędzenie":pos4.oszczędzenie,
                "relacje":pos4.relacje,
                "wochuk_uses":pos4.wochuk_uses,
                "cozwoj_uses":pos4.cozwoj_uses},
